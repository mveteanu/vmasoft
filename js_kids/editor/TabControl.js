...
function TabControl(tabControlName, pagesContainerName)
{
    ...
    function selectPage(pageHeaderObjOrName)
    {
        ...
        var oPageHeader = typeof pageHeaderObjOrName == "string" 
                            ? findPage(pageHeaderObjOrName)
                            : pageHeaderObjOrName;
    ...
    function removePage(pageHeaderObjOrName)
    {
        ...
        var pageName = typeof pageHeaderObjOrName == "string" 
                            ? pageHeaderObjOrName
                            : getPageName(oPageHeader);
    ...
    function handlePageEditExit(e)
    {
        ...
        var otherPage = findPage(pageName);
